...
$config->testsuite->datatable->defaultField = array('id', 'pri', 'caseNumber', 'title', 'type', 'assignedTo', 'lastRunner', 'lastRunDate', 'lastRunResult', 'status', 'bugs', 'results', 'actions');
