  ...
  <table align='center' class='table table-form table-fixed'>
    <thead>
      <tr>
        ...
        <th class='w-180px'><?php echo $lang->testcase->caseNumber;?></th>        
        ...
        <th class='w-150px'><?php echo $lang->testcase->purpose;?></th>
        <th class='w-150px'><?php echo $lang->testcase->precondition;?></th>
        <th class='w-150px'><?php echo $lang->testcase->input;?></th>
    ...
    <tr class='text-center'>
      ...
      <td><?php echo html::input("caseNumber[$i]", '', "class='form-control' autocomplete='off'");?></td>
      ...
      <td><?php echo html::textarea("purpose[$i]", '', "rows='1' class='form-control autosize'")?></td>
      <td><?php echo html::textarea("precondition[$i]", '', "rows='1' class='form-control autosize'")?></td>
      <td><?php echo html::textarea("input[$i]", '', "rows='1' class='form-control autosize'")?></td>
...
<table class='hide' id='trTemp'>
  <tbody>
    <tr class='text-center'>
      ...
      <td><?php echo html::input("caseNumber[%s]", '', "class='form-control' autocomplete='off'");?></td>
      <td style='overflow:visible'>
        <div class='input-group'>
      ...
      <td><?php echo html::textarea("purpose[%s]", '', "class='form-control'")?></td>
      <td><?php echo html::textarea("precondition[%s]", '', "class='form-control'")?></td>
      <td><?php echo html::textarea("input[%s]", '', "class='form-control'")?></td>
