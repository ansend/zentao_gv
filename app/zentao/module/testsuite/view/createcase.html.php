...
<div class='container mw-1400px'>
  ...
  <form class='form-condensed' method='post' enctype='multipart/form-data' id='dataform' target='hiddenwin'>
    <table class='table table-form'>
      ...
      <tr>
        <th><?php echo $lang->testcase->caseNumber;?></th>
        <td colspan='2'><?php echo html::input('caseNumber', $caseNumber, "class='form-control' autocomplete='off'");?></td>
      </tr>             
      <tr>
      ...
      <tr>
        ...
        <td colspan='2'><?php echo html::input('purpose', '', "class='form-control' autocomplete='off'");?></td>
      </tr>      
      <tr>
      ...
      <tr>
        <th><?php echo $lang->testcase->input;?></th>
        <td colspan='2'><?php echo html::textarea('input', $input, " rows='2' class='form-control'");?></td>
      </tr>
      <tr>
      ...
      <tr>
        <th><?php echo $lang->testcase->memo;?></th>
        <td colspan='2'><?php echo html::input('memo', '', "class='form-control' autocomplete='off'");?></td>
      </tr>      
      <tr>
