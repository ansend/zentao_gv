...
<div class='main'>
  ...
  <form id='batchForm' method='post'>
    ...
    <table class='table table-condensed table-hover table-striped tablesorter table-fixed table-selectable' id='caseList'>
      <thead>
        <tr>
          <th class='{sorter:false}'>         <?php common::printOrderLink('caseNumber',    $orderBy, $vars, $lang->idAB);?></th>
      ...
      <tr class='text-center'>
        ...
        <td class='cell-id'>
          ...
          <?php
            //echo html::a($viewLink, sprintf('%03d', $case->id));
            if("" != $case->caseNumber)
            {
              echo html::a($viewLink, $case->caseNumber);
            }
            else
            {
            	echo html::a($viewLink, " ");
            }
          ?>
        </td>
