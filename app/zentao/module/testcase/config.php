...
$config->testcase->exportFields = '
    id, caseNumber, product, branch, module, story,
...
$config->testcase->search['fields']['caseNumber']     = $lang->testcase->caseNumber;
...
$config->testcase->search['params']['caseNumber']   = array('operator' => 'include', 'control' => 'input',  'values' => '');
...
$config->testcase->datatable->defaultField = array('id', 'caseNumber', 'pri', 'title', 'type', 'openedBy', 'lastRunner', 'lastRunDate', 'lastRunResult', 'status', 'bugs', 'results', 'stepNumber', 'actions');
...
$config->testcase->datatable->fieldList['caseNumber']['title']    = $lang->testcase->caseNumber;
$config->testcase->datatable->fieldList['caseNumber']['fixed']    = 'left';
$config->testcase->datatable->fieldList['caseNumber']['width']    = '120';
$config->testcase->datatable->fieldList['caseNumber']['required'] = 'yes';
