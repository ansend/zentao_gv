  ...
  <table class='table table-form table-fixed'>
    <thead>
      <tr>
        ...
        <th><?php echo $lang->testcase->caseNumber;?> <span class='required'></span></th>
        ...
        <th class='<?php echo zget($visibleFields, 'purpose', 'hidden')?>'>
          <?php echo $lang->testcase->purpose;?>
          <?php if(isset($requiredFields['purpose'])) echo " <span class='required'></span>";?>
        </th>
        ...
        <th class='<?php echo zget($visibleFields, 'input', 'hidden')?>'>
          <?php echo $lang->testcase->input;?>
          <?php if(isset($requiredFields['input'])) echo " <span class='required'></span>";?>
        </th>        
    ...
    <tbody>
      ...
      <tr class='text-center'>
        ...
        <td style='overflow:visible' title='<?php echo $cases[$caseID]->caseNumber?>'>
          <div class='input-group'>
          <?php echo html::input("caseNumbers[$caseID]", $cases[$caseID]->caseNumber, "class='form-control' autocomplete='off'"); echo "<span class='star'>*</span>";?>
          </div>
        </td>        	
        ...
        <td class='<?php echo zget($visibleFields, 'purpose', 'hidden')?>'><?php echo html::textarea("purpose[$caseID]", $cases[$caseID]->purpose, "rows='1' class='form-control autosize'")?></td>
        ...
        <td class='<?php echo zget($visibleFields, 'input', 'hidden')?>'><?php echo html::textarea("input[$caseID]", $cases[$caseID]->input, "rows='1' class='form-control autosize'")?></td>
