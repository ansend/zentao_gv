  ...
  <form class='form-condensed' method='post' enctype='multipart/form-data' id='dataform' data-type='ajax'>
    <table class='table table-form'>
      ...
      <tr>
        ...
        <td colspan='2'><?php echo html::textarea('caseNumber', $caseNumber, " rows='2' class='form-control'");?></td>
      </tr>      
      <tr>
      ...
      <tr>
        ...
        <td colspan='2'><?php echo html::textarea('purpose', $purpose, " rows='2' class='form-control'");?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan='2'><?php echo html::textarea('memo', $memo, " rows='2' class='form-control'");?></td>
      </tr>      
