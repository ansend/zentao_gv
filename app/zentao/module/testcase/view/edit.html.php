    ...
    <div class='main'>
      <div class='form-group'>
        <div class='input-group'>
          <input type='hidden' id='color' name='color' data-provide='colorpicker' data-wrapper='input-group-btn fix-border-right' data-pull-menu-right='false' data-btn-tip='<?php echo $lang->case->colorTag ?>' value='<?php echo $case->color ?>' data-update-text='#caseNumber, .case-Number'>
          <?php echo html::input('caseNumber', $case->caseNumber, 'class="form-control" autocomplete="off" placeholder="' . $lang->case->caseNumber . '"');?>
        </div>
        <div class='input-group'>
      ...
      <fieldset class='fieldset-pure'>
        <legend><?php echo $lang->testcase->purpose;?></legend>
        <div class='form-group'><?php echo html::textarea('purpose', $case->purpose, "rows='4' class='form-control'");?></div>
      </fieldset>
      <fieldset class='fieldset-pure'>
      ...
      <fieldset class='fieldset-pure'>
        <legend><?php echo $lang->testcase->input;?></legend>
        <div class='form-group'><?php echo html::textarea('input', $case->input, "rows='4' class='form-control'");?></div>
      </fieldset>
      <fieldset class='fieldset-pure'>
...
-->
      <fieldset class='fieldset-pure'>
        <legend><?php echo $lang->testcase->memo;?></legend>
        <div class='form-group'><?php echo html::textarea('memo', $case->memo, "rows='4' class='form-control'");?></div>
      </fieldset>
      <fieldset class='fieldset-pure'>
