      ...
      <thead>
        <tr>
         ...
         <!-- <th class='w-80px'><?php echo $lang->product->activeStories;?></th>
          ...
          <th class='w-140px'><?php echo $lang->product->plans;?></th>
          <th class='w-140px'><?php echo $lang->product->releases;?></th>
          <th class='w-140px'><?php echo $lang->product->bugs;?></th> 
          <th class='w-140px'><?php echo $lang->product->unResolvedBugs;?></th>
          <th class='w-140px'><?php echo $lang->product->assignToNullBugs;?></th>
          <?php if($canOrder):?>
