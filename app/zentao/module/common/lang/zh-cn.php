...
//ansen remove pro version update
...
$lang->proVersion = "<a href='' target='_blank' id='proLink' class='text-important'><i class='text-danger icon-pro-version'></i></a> &nbsp; ";
...
if(isset($config->global->flow) and $config->global->flow == 'onlyTest')
{
    ...
    // add by ansen for rename 套件 to 用例套件
    $lang->menu->bug       = 'Bug|bug|index';
    $lang->menu->testcase  = '用例|testcase|index';
    $lang->menu->testsuite = '用例套件|testsuite|index';
    ...
    // add by ansen for test zero story requirement
    $lang->testcase->menu->zerocase    = '零用例需求|story|zeroCase|productID=%s';
    ...
    //add by ansen ,another way to add menu item.
    //$lang->product->menu->story1    = '需求22|product|browse|productID=%s';
    
    $lang->product->menuOrder[5]  = 'build';
    $lang->product->menuOrder[10] = 'view';
    $lang->product->menuOrder[15] = 'order';
    //$lang->product->menuOrder[20] = 'story1';
