...
$config->testcase->exportFields = '
    ...
    lastEditedBy, lastEditedDate, version, linkCase, case_num, case_purpose, case_input';
...
$config->testcase->search['fields']['case_num']       = $lang->testcase->case_num;
$config->testcase->search['fields']['case_purpose']   = $lang->testcase->case_purpose;
$config->testcase->search['fields']['case_input']     = $lang->testcase->case_input;
$config->testcase->search['fields']['case_memo']      = $lang->testcase->case_memo;
...
$config->testcase->datatable->defaultField = array('id', 'pri', 'title', 'type', 'openedBy', 'lastRunner', 'lastRunDate', 'lastRunResult', 'status', 'bugs', 'results', 'stepNumber', 'actions', 'case_num', 'case_purpose','case_input');
...
$config->testcase->datatable->fieldList['stepNumber']['title']    = 'case_num';
$config->testcase->datatable->fieldList['stepNumber']['fixed']    = 'no';
$config->testcase->datatable->fieldList['stepNumber']['width']    = '30';
$config->testcase->datatable->fieldList['stepNumber']['required'] = 'no';
$config->testcase->datatable->fieldList['stepNumber']['sort']     = 'no';
$config->testcase->datatable->fieldList['stepNumber']['name']     = $lang->testcase->case_num;

$config->testcase->datatable->fieldList['stepNumber']['title']    = 'case_purpose';
$config->testcase->datatable->fieldList['stepNumber']['fixed']    = 'no';
$config->testcase->datatable->fieldList['stepNumber']['width']    = '30';
$config->testcase->datatable->fieldList['stepNumber']['required'] = 'no';
$config->testcase->datatable->fieldList['stepNumber']['sort']     = 'no';
$config->testcase->datatable->fieldList['stepNumber']['name']     = $lang->testcase->case_purpose;

$config->testcase->datatable->fieldList['stepNumber']['title']    = 'case_input';
$config->testcase->datatable->fieldList['stepNumber']['fixed']    = 'no';
$config->testcase->datatable->fieldList['stepNumber']['width']    = '30';
$config->testcase->datatable->fieldList['stepNumber']['required'] = 'no';
$config->testcase->datatable->fieldList['stepNumber']['sort']     = 'no';
$config->testcase->datatable->fieldList['stepNumber']['name']     = $lang->testcase->case_input;
