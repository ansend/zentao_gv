...
$config->story->list->customCreateFields      = 'source,verify,pri,mailto,keywords';
...
$config->story->list->customBatchEditFields   = 'branch,plan,pri,assignedTo,source,stage,closedBy,closedReason,keywords';
